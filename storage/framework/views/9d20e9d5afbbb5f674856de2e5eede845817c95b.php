                 ...
                 <div class="row">
                    <div class="col-md-6 col-lg-6 col-sm-12">
                        <div class="banner-img-area border p-2 shadow">
                         <a href="dist/img/photo1.png" data-toggle="lightbox" data-title="Daily Route Banner"> <img class="d-block w-100" src="dist/img/photo1.png" style="height: 200px; object-position: center; object-fit: cover;"></a>
                         <p class="mt-2">Daily Route Banner</p>
                        </div>
                      </div>
                      <div class="col-md-6 col-lg-6 col-sm-12">
                        <div class="banner-img-area border p-2 shadow">
                         <a href="dist/img/map.jpg" data-toggle="lightbox" data-title="Daily Route Map"> <img class="d-block w-100" src="dist/img/map.jpg" style="height: 200px; object-position: center; object-fit: cover;"></a>
                    ...
                    <div class="row">
                      ...
                      <source src="dist/audio.mp3" type="audio/mp4" />
                       ...
                       cillum dolore eu fugiat nulla pariatur.</p>
                        <a href="<?php echo e(route('add_pointofinterest')); ?>" class="btn btn-info float-right">+ Add Point Of Interest</a>
                      </div>
                    </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="<?php echo e(route('details_pointofinterest')); ?>" class="btn btn-sm btn-info" title="Add Point Of Interest"><i class="fa fa-eye"></i></a>
                ...
                <div class="tab-pane fade" id="pills-french" role="tabpanel">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="<?php echo e(route('details_pointofinterest')); ?>" class="btn btn-sm btn-info" title="View Point Of Interest"><i class="fa fa-eye"></i></a>
                        <a href="#" class="btn btn-sm btn-info" title="Edit"><i class="fa fa-edit"></i></a> 
                        <a href="#" class="btn btn-sm btn-info" title="Delete"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
