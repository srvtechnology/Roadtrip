                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="banner-img-area border p-2 shadow">
                                        <a href="<?php echo url('/'); ?>/image_route/<?php echo e($route_details[0]->route_top_banner_img); ?>"
                                            data-toggle="lightbox" data-title="Top Banner Image"> <img class="d-block w-100"
                                                src="<?php echo url('/'); ?>/image_route/<?php echo e($route_details[0]->route_top_banner_img); ?>"
                                                style="height: 200px; object-position: center; object-fit: cover;"></a>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="banner-img-area border p-2 shadow">
                                        <a href="<?php echo url('/'); ?>/image_route/<?php echo e($route_details[0]->route_map_banner_img); ?>"
                                            data-toggle="lightbox" data-title="Map Banner Image"> <img class="d-block w-100"
                                                src="<?php echo url('/'); ?>/image_route/<?php echo e($route_details[0]->route_map_banner_img); ?>"
                                                style="height: 200px; object-position: center; object-fit: cover;"></a>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="align-middle"> <audio controls="controls" onplay="pauseOthers(this);"
                                                                    ...
                                                                    <source src="<?php echo url('/'); ?>/audio_route/<?php echo e($route_details[0]->route_audio_en); ?>"  />
                                                                </audio></td>
                                                        </tr>
                                                ...
                                                <tbody>
                                                  <?php for($i = 0; $i < count($poi_list); $i++): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle"><img src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_list[$i]->poi_img_1); ?>"></td>
                                                        ...
                                                        <td class="align-middle text-center"><audio controls="controls" onplay="pauseOthers(this);"
                                                                controlslist="nodownload">
                                                                <source src="<?php echo url('/'); ?>/audio_route/<?php echo e($poi_list[$i]->poi_audio_en); ?>" />
                                                            </audio></td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="align-middle"> <audio controls="controls"
                                                                    controlslist="nodownload">
                                                                    <source src="<?php echo url('/'); ?>/audio_route/<?php echo e($route_details[0]->route_audio_fr); ?>" />
                                                                </audio></td>
                                                        </tr>
                                                ...
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="align-middle"> <audio controls="controls"
                                                                    controlslist="nodownload">
                                                                    <source src="<?php echo url('/'); ?>/audio_route/<?php echo e($route_details[0]->route_audio_de); ?>"  />
                                                                </audio></td>
                                                        </tr>
