                    ...
                    <table id="list_daily_route_all" class="table route_table  table-striped">
                        ...
                        <tbody>
                          ...
                          <?php for($i = 0; $i < count($route_list); $i++): ?>
                        		...
                        		<td class="align-middle"><img  src="<?php echo url('/'); ?>/image_route/<?php echo e($route_list[$i]->route_top_banner_img); ?>"></td>
                        		<td class="align-middle"><img  src="<?php echo url('/'); ?>/image_route/<?php echo e($route_list[$i]->route_map_banner_img); ?>"></td>
