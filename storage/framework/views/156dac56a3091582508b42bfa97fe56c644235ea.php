                                ...
                                <tbody>
                                  <tr>
                                    <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                      ...
                                      padding: 0'><span style="text-transform:uppercase">PASSWORT ZURÜCKSETZEN </span></h2>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                                ...
                                <tbody>
                                  <tr>
                                    <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                      ...
                                      line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
                                      padding-bottom: 9px; padding-left: 18px;' valign="top">Keine Sorge, <br> wir kümmern uns um dein neues Passwort
                                      <br></br>
                                    </td>
                                  </tr>
                                </tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="mcnButtonContent" style="mso-line-height-rule:
                                              ...
                                              #FFFFFF; text-transform:uppercase;" target="_blank" title="Reset Password ">PASSWORT ZURÜCKSETZEN</a>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                ...
                                <tr>
                                  <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                    ...
                                    <p style='margin: 10px 0; padding: 0; mso-line-height-rule: exactly;
                                      ...
                                      <br><br>
                                     Wir haben eine Anfrage erhalten, dein
Passwort zurückzusetzen. Wenn du die
Anfrage nicht gestellt hast, ignoriere
diese Nachricht. Wenn du die Anfrage
gestellt hast, klicke auf den Button
PASSWORT VERGESSEN.
                                      <br><br>
                                      Danke!
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                        ...
                                        <div style="text-align: center;"> @Copyright  2022 von
