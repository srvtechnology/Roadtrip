            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <div class="crad">
                        ...
                        <form method="post" action="<?php echo e(route('do_add_point_of_interest')); ?>">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number"
                                        ...
                                        maxlength="4" value="<?php echo e(old('sequence')); ?>" name="sequence">
                                </div>
                            ...
                            <input type="hidden" name="route_id" value="<?php echo e(@$route_id); ?>">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Add Area Of Interest Audio <i class="fa fa-music"></i> <span class="text-danger">*</span></label><br>
