          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="<?php echo e(route('add_podcast')); ?>" class="btn btn-info float-right">Add New Daily Route</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="<?php echo e(route('view_podcast')); ?>" class="btn btn-sm btn-info" title="View"><i class="fa fa-eye"></i></a>
