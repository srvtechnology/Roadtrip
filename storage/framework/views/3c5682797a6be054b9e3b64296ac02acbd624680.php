        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4 text-center">
                                    ...
                                    <label class="">Add Daily Route Map Image <span class="text-danger">*</span></label>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form method="post" id="en" action="<?php echo e(route('do_add_daily_route')); ?>">
                        ...
                        <div class="card languages" id="english" class="size_chart">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Daily Route Map Description <span class="text-danger">*</span></label>
                                    <textarea class="form-control" name="en_des" rows="6"
                                        placeholder="Daily Route Map Description (Maximum 200 Characters) "
                        ...
                        <div class="card language" id="french" >
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="fn_des" name="fr_des" rows="6"
                                        placeholder="Daily Route Map Description (Maximum 200 Characters)"
                                        maxlength="200"></textarea>
                                         <small>(Maximum 2000 Characters)</small>
                                </div>
                        ...
                        <div class="card language" id="german" >
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Daily Route Description</label>
                                    <textarea class="form-control" id="de_des" name="de_des" rows="6"
                                        placeholder="Daily Route Map Description (Maximum 200 Characters)"
                                        maxlength="200"></textarea>
                                        <small>(Maximum 2000 Characters)</small>
                                </div>
