...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" id="bodyTable" style="border-collapse: collapse; mso-table-lspace: 0;
      ...
      100%; background-color: #ffffff; height: 100%; margin: 0; padding: 0; width:
      100%" width="100%">
      <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="templateContainer" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0;
                  ...
                  <tr>
                    <td id="templateBody" style="mso-line-height-rule: exactly;
                      -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-image: url(<?php echo url('/'); ?>/email_css/images/background.webp); width: 100%; background-repeat: no-repeat; background-size: cover;
                      border-top: 0; border-bottom: 35px; padding-top:35px; padding-bottom: 0" valign="top">
                                ...
                                <tbody>
                                  <tr>
                                    <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                      ...
                                      <h2 class="null" style='color: #ffffff; font-family: "Asap", Helvetica,
                                      ...
                                      padding: 0'><span style="text-transform:uppercase">REINITIALISER LE MOT DE PASSE</span></h2>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                              ...
                              <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnTextContentContainer" style="border-collapse: collapse; mso-table-lspace: 0;
                                ...
                                <tbody>
                                  <tr>
                                    <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                      -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; word-break: break-word;
                                      color: #ffffff; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
                                      line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
                                      padding-bottom: 9px; padding-left: 18px;' valign="top">Pas de problème! <br>Permet de vous obtenir un nouveau mot de passe
                                      <br></br>
                                    </td>
                                  </tr>
                                </tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="mcnButtonContent" style="mso-line-height-rule:
                                              ...
                                              <a class="mcnButton " href="http://demoyourprojects.website/projects/roadtrip/forgot_password/<?php echo md5($userName);?>/<?php echo base64_encode($userName);?>/<?php echo hash('sha256', $userName);?>/<?php echo $language_code ?>" style="mso-line-height-rule: exactly;
                                              ...
                                              #FFFFFF; text-transform:uppercase;" target="_blank" title="Reset Password ">REINITIALISER LE MOT DE PASSE</a>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                          ...
                          <tr>
                            <td class="mcnTextBlockInner" style="mso-line-height-rule: exactly;
                              ...
                              <table align="center" bgcolor="#F7F7FF" border="0" cellpadding="32" cellspacing="0" class="card" style="border-collapse: collapse; mso-table-lspace: 0;
                                mso-table-rspace: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust:
                                100%; background:#f1f1f1; margin:auto; text-align:left; max-width:600px;
                                ...
                                <tr>
                                  <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                    ...
                                    0; text-align: left; width: 100%; font-size: 16px; font-weight: bold; '></h3>
                                    <p style='margin: 10px 0; padding: 0; mso-line-height-rule: exactly;
                                      -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #000000;
...
Si vous n’avez pas fait la demande,
veuillez ignorer le message. Si vous
avez demandé
à réinitialiser vortre mot
de passe, veuillez suivre le bouton ci
-
dessus pour réinitialiser vortr mot de
passe. 
                                      <br><br>
                                      Merci!
                                      <br>
                                     Votre équipe ROAD TRIP USA
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                        ...
                                        padding-bottom: 24px; padding-left: 18px; color: #121212; font-family: 'Asap',
                                        Helvetica, sans-serif; font-size: 12px;" valign="top">
                                        <div style="text-align: center;">@droits  d’auteur 2022 de
                                          <a href="#" style="mso-line-height-rule: exactly;
                                            -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #121212;
                                          font-weight: normal; text-decoration: none; color:#121212;" target="_blank" title="Noun Project - Icons for Everything">ROAD TRIP
USA
</a>
                                        </div>
                                      </td>
                                  ...
                                  <!-- <tr>
                                    <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                      ...
                                      <a href="#" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                        ...
                                        <img alt="twitter" height="32" src="images/twitter-ic-32x32-email@2x.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none; text-decoration:
                                        none" width="32" />
                                      </a>
                                    </td>
                                    <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                      ...
                                      <a href="#" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                        ...
                                        none" target="_blank">
                                        <img alt="Instagram" height="32" src="images/instagram-ic-32x32-email@2x.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
                                    ...
                                    <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                      ...
                                      <a href="#" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                        -webkit-text-size-adjust: 100%; color: #f57153; font-weight: normal; text-decoration: none" target="_blank">
                                        <img alt="facebook" height="32" src="images/facebook-ic-32x32-email@2x.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
                                        text-decoration: none" width="32" />
                                      </a>
                                    </td>
                                  </tr> -->
