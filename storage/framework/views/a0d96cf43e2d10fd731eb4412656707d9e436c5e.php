            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="<?php echo e(route('do_list_package_add')); ?>"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" id="package_name" class="form-control" placeholder="Enter Package Name"
                                            required="" maxlength="25" value="<?php echo e(old('package_name')); ?>" name="package_name">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="8" value="<?php echo e(old('package_price')); ?>" name="package_price">
                                    </div>
                                    <div class="form-group col-md-4">
                                     ...
                                     <div class="clearfix"></div>
                                        ...
                                        <input type="text" id="package_name_fr" class="form-control" placeholder="Enter Package Name"
                                            required="" maxlength="25" value="<?php echo e(old('package_name_fr')); ?>" name="package_name_fr">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="8" value="<?php echo e(old('package_price')); ?>" name="package_price_fr">
                                    </div>
                                    ...
                                    <div class="clearfix"></div>
                                        ...
                                        <input type="text" id="package_name_de" class="form-control" placeholder="Enter Package Name"
                                            required="" maxlength="25" value="<?php echo e(old('package_name_de')); ?>" name="package_name_de">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="8" value="<?php echo e(old('package_price')); ?>" name="package_price_de">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control select2" multiple="" name="routes[]"
                                            data-placeholder="Select Daily Routes" >
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control select2" multiple="" name="podcasts[]"
                                            data-placeholder="Select Podcasts">
