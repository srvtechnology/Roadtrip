          ...
          <div class="col-12">
            <div class="card card-primary card-outline card-tabs">
              ...
              <div class="card-header">
                <a href="<?php echo e(route('add_daily_route')); ?>" class="btn btn-info float-right">Add New Daily Route</a>
              </div>
                    ...
                    <table id="list_daily_route_all" class="table route_table  table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="align-middle"><img  src="<?php echo url('/'); ?>/roadtrip/public/image_route/<?php echo e($route_list[$i]->route_top_banner_img); ?>"></td>
                          <td class="align-middle"><img  src="<?php echo url('/'); ?>/roadtrip/public/image_route/<?php echo e($route_list[$i]->route_map_banner_img); ?>"></td>
                          <td class="align-middle"><?php echo e($route_list[$i]->route_title_en); ?></td>
                          <td class="align-middle"><?php if($route_list[$i]->route_type=="0"): ?>
                            Clockwise
                            <?php else: ?>
                            Anticlockwise
                          <?php endif; ?></td>
                           <td class="align-middle">
                              <?php echo e($route_list[$i]->sequence); ?>

                          </td>
                          <td class="align-middle"><form method="POST" action="<?php echo e(route('view_point_of_interest')); ?>"/>
                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                            <input type="hidden" name="route_id" value="<?php echo e($route_list[$i]->route_id); ?>"/>
                            <button class="btn btn-sm btn-info" title="View &amp; add Point Of Interest"><i class="fa fa-eye"></i></button>
                            
                            <a href="<?php echo e(route('edit_daily_route',['route_id'=>base64_encode($route_list[$i]->route_id)])); ?>" class="btn btn-sm btn-info" title="Edit"><i class="fa fa-edit"></i></a>
                            <a style="color: white;" data-toggle="modal" data-target="#modal-<?php echo e($route_list[$i]->route_id); ?>" class="btn btn-sm btn-info" title="Delete"><i class="fa fa-trash"></i></a>
                          </form></td>
                        </tr>
                        <!-- Modal -->
                        <div class="modal fade" id="modal-<?php echo e($route_list[$i]->route_id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <div class="modal-body">
                                <form method="POST" action="all_type_delete">
                                  ...
                                  <div class="message-txt text-center">
                                    ...
                                    <h5><?php echo e($route_list[$i]->route_title_en); ?></h5>
                  ...
                  <div class="tab-pane fade" id="custom-tabs-three-clockwise" role="tabpanel" aria-labelledby="custom-tabs-three-profile-tab">
                    <table id="list_daily_route_clockwise" class="table route_table  table-striped">
                      ...
                      <tbody>
                        ...
                        <?php if($route_list[$i]->route_type=="0"): ?>
                        
                        <tr>
                          <td class="align-middle"><?php echo e($j); ?><?php $j=$j+1 ?></td>
                          <td class="align-middle"><img  src="<?php echo url('/'); ?>/roadtrip/public/image_route/<?php echo e($route_list[$i]->route_top_banner_img); ?>"></td>
                          <td class="align-middle"><img  src="<?php echo url('/'); ?>/roadtrip/public/image_route/<?php echo e($route_list[$i]->route_map_banner_img); ?>"></td>
                          <td class="align-middle"><?php echo e($route_list[$i]->route_title_en); ?></td>
                          ...
                          <td class="align-middle"><form method="POST" action="<?php echo e(route('view_point_of_interest')); ?>"/>
                            ...
                            <a href="<?php echo e(route('edit_daily_route',['route_id'=>base64_encode($route_list[$i]->route_id)])); ?>" class="btn btn-sm btn-info" title="Edit"><i class="fa fa-edit"></i></a>
                            <a style="color: white;" data-toggle="modal" data-target="#modalclock-<?php echo e($route_list[$i]->route_id); ?>" class="btn btn-sm btn-info" title="Delete"><i class="fa fa-trash"></i></a>
                          </form></td>
                        </tr>
                        <!-- Modal -->
                        <div class="modal fade" id="modalclock-<?php echo e($route_list[$i]->route_id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              <div class="modal-header">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="align-middle"> <form method="POST" action="<?php echo e(route('view_point_of_interest')); ?>"/>
                            ...
                            <a href="<?php echo e(route('edit_daily_route',['route_id'=>base64_encode($route_list[$i]->route_id)])); ?>" class="btn btn-sm btn-info" title="Edit"><i class="fa fa-edit"></i></a>
                            <a style="color: white;" data-toggle="modal" data-target="#modalanti-<?php echo e($route_list[$i]->route_id); ?>" class="btn btn-sm btn-info" title="Delete"><i class="fa fa-trash"></i></a>
                          </form> </td>
                        </tr>
                        <!-- Modal -->
                        <div class="modal fade" id="modalanti-<?php echo e($route_list[$i]->route_id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              <div class="modal-header">
