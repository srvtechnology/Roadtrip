 <?php if(session() && session()->has('roadtrip_admin')): ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <nav class="main-header navbar navbar-expand  navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <!-- <li class="nav-item d-none d-sm-inline-block">
        <a  class="nav-link"><?php echo e(Request::segment(1)); ?></a>
      </li> -->
   ...
   <ul class="navbar-nav ml-auto">
     <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(route('admin_logout')); ?>" class="nav-link">Logout</a>
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4" style="background-image: url(<?php echo url('/'); ?>/dist/img/Splash_bg.png); ">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="brand-link">
      <img src="<?php echo url('/'); ?>/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Road Trip USA</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <?php if(Request::segment(1) == "user_list"): ?>
            <a href="<?php echo e(route('user_list')); ?>" class="nav-link active">
            <?php else: ?>
           ...
           <li class="nav-item">
             <?php if(Request::segment(1) == "daily_route_list"): ?>
             <a href="<?php echo e(route('daily_route_list')); ?>" class="nav-link active">
             <?php else: ?>
             <a href="<?php echo e(route('daily_route_list')); ?>" class="nav-link ">
             <?php endif; ?>
          ...
          <!--
            <li class="nav-item">
            <?php if(Request::segment(1) == "list_dailyroute_map" || Request::segment(1) == "add_dailyroute_map"): ?>
             <a href="<?php echo e(route('list_dailyroute_map')); ?>" class="nav-link active">
            <?php else: ?>
             <a href="<?php echo e(route('list_dailyroute_map')); ?>" class="nav-link ">
            <?php endif; ?>
        ...
        -->
           ...
           <li class="nav-item">
            <?php if(Request::segment(1) == "podcast_list" || Request::segment(1) == "add_podcast" || Request::segment(1) == "edit_podcast" || Request::segment(1) == "view_podcast" ): ?>
            <a href="<?php echo e(route('podcast_list')); ?>" class="nav-link active">
            <?php else: ?>
             <a href="<?php echo e(route('podcast_list')); ?>" class="nav-link ">
            <?php endif; ?>  
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('list_payment')); ?>" class="nav-link">
          ...
          <li class="nav-item">
             <?php if(Request::segment(1) == "list_package" || Request::segment(1) == "list_package_edit"): ?>
            <a href="<?php echo e(route('list_package')); ?>" class="nav-link active">
                <?php else: ?>
            <a href="<?php echo e(route('list_package')); ?>" class="nav-link">
            <?php endif; ?>
