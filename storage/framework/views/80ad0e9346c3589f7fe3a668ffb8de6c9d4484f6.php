                                ...
                                <div class="flex-area">
                                        ...
                                        <div class="phto-set border p-2 text-center">
                                            <label for="place_1"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_details[0]->poi_img_1); ?>" id="thumbnil"></label>
                                        ...
                                        <div class="phto-set border p-2 text-center">
                                            ...
                                            <label for="place_2"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_details[0]->poi_img_2); ?>" id="thumbnil2"></label>
                                            <?php else: ?>
                                            <label for="place_2"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <?php if($poi_details[0]->poi_img_3!=""): ?>
                                            <label for="place_3"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_details[0]->poi_img_3); ?>" id="thumbnil3"></label>
                                                    <?php else: ?>
                                            <label for="place_3"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <label for="place_4"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_details[0]->poi_img_4); ?>" id="thumbnil4"></label>
                                                    <?php else: ?>
                                            <label for="place_4"><img style="max-height: 120px; max-width: 100%;"
                                    ...
                                    <!-- Additional images -->
                                        ...
                                        <?php if($poi_details[0]->poi_img_5!=""): ?>  
                                            <label for="place_5"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_details[0]->poi_img_5); ?>" id="thumbnil5"></label>
                                                    <?php else: ?>
                                            <label for="place_5"><img style="max-height: 120px; max-width: 100%;"
                                   ...
                                   <div class="flex-area">
                                        ...
                                        <label for="place_6"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_details[0]->poi_img_6); ?>" id="thumbnil6"></label>
                                                    <?php else: ?>
                                            <label for="place_6"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <label for="place_7"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_details[0]->poi_img_7); ?>" id="thumbnil7"></label>
                                                    <?php else: ?>
                                            <label for="place_7"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <label for="place_8"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_details[0]->poi_img_8); ?>" id="thumbnil8"></label>
                                                    <?php else: ?>
                                            <label for="place_8"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <label for="place_9"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_details[0]->poi_img_9); ?>" id="thumbnil9"></label>
                                                    <?php else: ?>
                                            <label for="place_9"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <label for="place_10"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/image_route/<?php echo e($poi_details[0]->poi_img_10); ?>" id="thumbnil10"></label>
                                                    <?php else: ?>
                                            <label for="place_10"><img style="max-height: 120px; max-width: 100%;"
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('do_edit_point_of_interest')); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                    ...
                                    <div class="d-flex justify-content-left"><label class="image-previewer"><img
                                        ...
                                        <source src="<?php echo url('/'); ?>/audio_route/<?php echo e($poi_details[0]->poi_audio_en); ?>"  />
                                    </audio>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                    <div class="form-group">
                                        <label>POI Name For French <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Add Point Of Interest Audio For French <i class="fa fa-music"></i> <span class="text-danger">*</span></label><br>
                                    ...
                                    <div class="d-flex justify-content-left"><label class="image-previewer"><img
                                         ...
                                         <audio controls="controls" controlslist="nodownload" id="output">
                                        <source src="<?php echo url('/'); ?>/audio_route/<?php echo e($poi_details[0]->poi_audio_fr); ?>"  />
                                            <?php else: ?>
                                            <P>No Audio</P>
                                        <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        <label>POI Description For French  <span class="text-danger">*</span></label>
                           ...
                           <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                    <div class="form-group">
                                        <label>POI Name For German <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" maxlength="100" placeholder="Place Name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Add Point Of Interest Audio For German <i class="fa fa-music"></i> <span class="text-danger">*</span></label><br>
                                    ...
                                    <div class="d-flex justify-content-left"><label class="image-previewer"><img
                                        ...
                                        <audio controls="controls" controlslist="nodownload" id="output">
                                        <source src="<?php echo url('/'); ?>/audio_route/<?php echo e($poi_details[0]->poi_audio_de); ?>"  />
                                    </audio>
                                      <?php else: ?>
                                            <P>No Audio</P>
                                    ...
                                    <div class="form-group">
                                        <label>POI Description For German  <span class="text-danger">*</span></label>
