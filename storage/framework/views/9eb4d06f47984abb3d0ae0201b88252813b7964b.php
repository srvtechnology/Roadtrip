...
<head>
  ...
  <style type="text/css">
    ...
    @media  only screen and (max-width: 480px) {
      ...
      /*
      @tab  Mobile Styles
      <?php $__env->startSection; ?> Heading 1
   ...
   on small screens.
    ...
    @media  only screen and (max-width: 480px) {
      ...
      /*
      @tab  Mobile Styles
      <?php $__env->startSection; ?> Heading 2
   ...
   readability on small screens.
    ...
    @media  only screen and (max-width: 480px) {
      ...
      /*
      @tab  Mobile Styles
      <?php $__env->startSection; ?> Heading 3
   ...
   on small screens.
    ...
    @media  only screen and (max-width: 480px) {
      ...
      /*
      @tab  Mobile Styles
      <?php $__env->startSection; ?> Heading 4
   ...
   readability on small screens.
    ...
    @media  only screen and (max-width: 480px) {
      ...
      /*
      @tab  Mobile Styles
      <?php $__env->startSection; ?> Boxed Text
   ...
   screens. We recommend a font size of at least 16px.
    ...
    @media  only screen and (max-width: 480px) {
      ...
      /*
      @tab  Mobile Styles
      <?php $__env->startSection; ?> Preheader Visibility
   ...
   can hide it to save space.
    ...
    @media  only screen and (max-width: 480px) {
      ...
      /*
      @tab  Mobile Styles
      <?php $__env->startSection; ?> Preheader Text
   ...
   screens.
    ...
    @media  only screen and (max-width: 480px) {
      ...
      /*
      @tab  Mobile Styles
      <?php $__env->startSection; ?> Body Text
   ...
   screens. We recommend a font size of at least 16px.
    ...
    @media  only screen and (max-width: 480px) {
      ...
      /*
      @tab  Mobile Styles
      <?php $__env->startSection; ?> Footer Text
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #C68F60; height: 100%; margin: 0; padding: 0; width: 100%">
  <center>
 ...
 100%; background-color: #C68F60; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
      <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #C68F60;
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-image: url(images/background.webp); width: 100%; background-repeat: no-repeat; background-size: cover;
 ...
 padding: 0'><span style="text-transform:uppercase">Forgot password?</span></h2>
 ...
 0; text-align: left; width: 100%; font-size: 16px; font-weight: bold; '>About
                                Road Trip 2.0</h3>
 ...
 text-align: left; text-align: left; font-size: 14px; '>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.
                              </p>
 ...
 Helvetica, sans-serif; font-size: 12px;" valign="top">
                                <div style="text-align: center;">@ Copyright 2021
                                  by
                                  <a href="#" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #121212;
 font-weight: normal; text-decoration: none; color:#121212;" target="_blank" title="Noun Project - Icons for Everything">Road Trip 2.0</a>
                                </div>
                              </td>
                            </tr>
                          <tbody></tbody>
