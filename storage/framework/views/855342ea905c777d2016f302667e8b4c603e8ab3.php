                                   ...
                                   <div class="form-group col-md-6 text-left">
                                        ...
                                        <label for="package-img-new"
                                            style="max-width: 100%; max-height: 100%;display: flex; justify-content: center; align-items: center;"><img
                                                ...
                                                src="<?php echo url('/'); ?>/package_images/<?php echo e($package->package_image); ?>">
                                        </label> 
                                        <div class="set-label">
                                   ...
                                   <div class="form-group col-md-6 text-left">
                                        ...
                                        <label for="package-active-img-new"
                                            style="max-width: 100%; max-height: 100%;display: flex; justify-content: center; align-items: center;"><img
                                                ...
                                                src="<?php echo url('/'); ?>/package_images/<?php echo e($package->active_image); ?>">
                                        </label> 
                                        <div class="set-label">
                                   ...
                                   <!--  <div class="form-group col-md-6 text-center">
                                        <label for="package-img">Package Image <span class="text-danger">*</span></label>
                                         <div class="phto-set border pt-2 pb-2 text-center" style="height: 180px;">
                                            ...
                                            <label for="package-img" style="max-width: 100%; max-height: 100%; display: flex; justify-content: center; align-items: center;"><img id="output" style="max-height: 100%; max-width: 100%;"  src="<?php echo url('/'); ?>/package_images/<?php echo e($package->package_image); ?>"></label>
                                            <div class="set-label">
                                   ...
                                   <!--  <div class="form-group col-md-6 text-center">
                                    <label for="active-img">Package Active Image <span class="text-danger">*</span></label>
                                      <div class="phto-set border pt-2 pb-2 text-center" style="height: 180px;">
                                          ...
                                          <label for="active-img" style="max-width: 100%; max-height: 100%;  display: flex; justify-content: center; align-items: center;"><img id="output1" style="max-height: 100%; max-width: 100%;"  src="<?php echo url('/'); ?>/package_images/<?php echo e($package->active_image); ?>"></label>
                                          <div class="set-label">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control select2" multiple="" name="routes[]" >
                                            <?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <option value="<?php echo e($route->route_id); ?>"
                                                    <?php echo e(in_array($route->route_id, $existing_route_ids) ? 'selected' : ''); ?>>
                                                    <?php echo e($route->route_title_en); ?></option>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control select2" multiple="" name="podcasts[]" >
                                            <?php $__currentLoopData = $podcasts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $podcast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <option value="<?php echo e($podcast->pod_id); ?>"
                                                    <?php echo e(in_array($podcast->pod_id, $existing_pod_ids) ? 'selected' : ''); ?>>
                                                    <?php echo e($podcast->pod_title_en); ?>
