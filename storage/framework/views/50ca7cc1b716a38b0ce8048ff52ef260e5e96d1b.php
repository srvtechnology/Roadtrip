        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="phto-set border pt-2 pb-2 text-center" style="height: 150px;">
                                        <label for="banner-img"><img src="<?php echo url('/'); ?>/roadtrip/public/image_route/<?php echo e($route_details[0]->route_top_banner_img); ?>" id="thumbnil"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="phto-set border pt-2 pb-2 text-center">
                                        <label for="map-img"><img src="<?php echo url('/'); ?>/roadtrip/public/image_route/<?php echo e($route_details[0]->route_map_banner_img); ?>" id="thumbnil2"
                                                style="max-width:100%; max-height:100px;"></label>
                                        <div class="set-label">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="trip_type" name="trip_type">
                                    <option value="<?php echo e($route_details[0]->route_type); ?>" selected> 
                    ...
                    <div class="card language" id="japan" style="display: none" class="size_chart">
                        <form method="post" action="<?php echo e(route('do_add_daily_route')); ?>">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form method="post" id="en" action="<?php echo e(route('do_edit_daily_route')); ?>">
                        
                        <div class="card languages" id="english" class="size_chart">

                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                            <input type="hidden" name="image_hidden1" value="<?php echo e($route_details[0]->route_top_banner_img); ?>">
                            <input type="hidden" name="image_hidden2" value="<?php echo e($route_details[0]->route_map_banner_img); ?>">

                            <input type="hidden" name="audio_hidden1" value="<?php echo e($route_details[0]->route_audio_en); ?>">
                            <input type="hidden" name="audio_hidden2" value="<?php echo e($route_details[0]->route_audio_fr); ?>">
                            <input type="hidden" name="audio_hidden3" value="<?php echo e($route_details[0]->route_audio_de); ?>">
                            <input type="hidden" name="form" value="en">
                            <input type="hidden" name="trip_type_hidden" value="<?php echo e($route_details[0]->route_type); ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" class="form-control" placeholder="Enter Sequence"
                                    required=""  maxlength="8" value="<?php echo e(@$route_details[0]->sequence); ?>"  name="sequence">
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="en-audio" accept="audio/x-m4a" type="file" name="en_fileAudio" 
                                        style="display: none;" value="<?php echo url('/'); ?>/roadtrip/public/audio_route/<?php echo e($route_details[0]->route_audio_en); ?>" onchange="loadFile(event)"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Edit Daily Route Title"
                                        maxlength="100" name="en_title" value="<?php echo e($route_details[0]->route_title_en); ?>">
                                        <small>(Maximum 100 Characters)</small> 
                                </div>

                                <div class="form-group">
                                    <label>Edit Daily Route Description <span class="text-danger">*</span></label>
                                    <textarea class="form-control" name="en_des" rows="6"
                                        placeholder="Daily Route Description"
                                        maxlength="2000"><?php echo e($route_details[0]->route_description_en); ?></textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="fr-audio" class="btn btn-info">Upload <i
                                            class="fa fa-upload"></i></label>
                                    <input id="fr-audio" accept=".m4a" type="file" name="fr_fileAudio" value="<?php echo url('/'); ?>/roadtrip/public/audio_route/<?php echo e($route_details[0]->route_audio_fr); ?>"
                                        style="display: none;" />
                                ...
                                <div class="form-group">
                                    <label>Edit Daily Route Title </label>
                                    <input type="text" class="form-control" placeholder="Add Daily Route Title"
                                        maxlength="120" name="fr_title" value="<?php echo e($route_details[0]->route_title_fr); ?>">
                                         <small>(Maximum 100 Characters)</small> 
                                </div>

                                <div class="form-group">
                                    <label>Edit Daily Route Description</label>
                                    <textarea class="form-control"  name="fr_des" rows="2"
                                        placeholder="Daily Route Description (Maximum 2000 Characters)"
                                        maxlength="2000"><?php echo e($route_details[0]->route_description_fr); ?></textarea>
                                         <small>(Maximum 2000 Characters)</small> 
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="de-audio" class="btn btn-info">Upload <i
                                            class="fa fa-upload"></i></label>
                                    <input id="de-audio" accept=".m4a" type="file" name="de_fileAudio" value="<?php echo url('/'); ?>/roadtrip/public/audio_route/<?php echo e($route_details[0]->route_audio_de); ?>"
                                        style="display: none;" />
                                    <small id="emailHelp" class="form-text text-muted">(Accept Only M4A Audio)</small>
                                ...
                                <div class="form-group">
                                    <label>Edit Daily Route Title</label>
                                    <input type="text" class="form-control" placeholder="Add Daily Route Title"
                                        maxlength="120" name="de_title" value="<?php echo e($route_details[0]->route_title_de); ?>">
                                         <small>(Maximum 100 Characters)</small> 
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="de_des" name="de_des" rows="2"
                                        placeholder="Daily Route Description (Maximum 2000 Characters)"
                                        maxlength="2000"><?php echo e($route_details[0]->route_description_de); ?></textarea>
                                         <small>(Maximum 2000 Characters)</small> 
                                </div>
