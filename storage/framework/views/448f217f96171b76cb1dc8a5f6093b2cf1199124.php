                ...
                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="phto-set border pt-2 pb-2 text-center" style="height: 300px;">
                                            <label for="banner-img"><img
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_podcast/<?php echo e($pod_details[0]->pod_img); ?>"
                            ...
                            <form method="post" action="<?php echo e(route('do_edit_podcast')); ?>">
                             <div class="row">
                                ...
                                <input type="number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" class="form-control" placeholder="Enter Sequence"
                                    required=""  maxlength="8" value="<?php echo e(@$pod_details[0]->sequence); ?>"  name="sequence">
                                </div>
                                ...
                                <input type="hidden" name="image_hidden1" value="<?php echo e($pod_details[0]->pod_img); ?>">


                                <input type="hidden" name="audio_hidden1" value="<?php echo e($pod_details[0]->pod_audio_en); ?>">
                                <input type="hidden" name="audio_hidden2" value="<?php echo e($pod_details[0]->pod_audio_fr); ?>">
                                <input type="hidden" name="audio_hidden3" value="<?php echo e($pod_details[0]->pod_audio_de); ?>">

                                <input type="hidden" name="pod_id" value="<?php echo e($pod_details[0]->pod_id); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <audio controls="controls"  controlslist="nodownload" id="output"  
                                        >
                                        <source src="<?php echo url('/'); ?>/roadtrip/public/audio_podcast/<?php echo e($pod_details[0]->pod_audio_en); ?>"  />
                                    </audio>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Add Podcast Title"
                                        ...
                                        value="<?php echo e($pod_details[0]->pod_title_en); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="en_des" rows="2"
                                        ...
                                        required><?php echo e($pod_details[0]->pod_description_en); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Podcast Duration"
                                        ...
                                        value="<?php echo e($pod_details[0]->duration_in_min); ?>">
                                        <small>(Maximum 120 Characters)</small>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <audio controls="controls" controlslist="nodownload" id=""
                                        >
                                        <source src="<?php echo url('/'); ?>/roadtrip/public/audio_podcast/<?php echo e($pod_details[0]->pod_audio_fr); ?>" />
                                    </audio>
                            </div>
                            <div class="form-group">
                                <label>Add Podcast Title</label>
                                <input type="text" class="form-control" placeholder="Add Podcast Title" maxlength="120"
                                    name="fr_title" required value="<?php echo e($pod_details[0]->pod_title_fr); ?>">
                                    <small>(Maximum 120 Characters)</small>
                            </div>
                            <div class="form-group">
                                <label>Podcast Description</label>
                                <textarea class="form-control" name="fr_des" rows="2" placeholder="Podcast Description"
                                    maxlength="200" required><?php echo e($pod_details[0]->pod_description_fr); ?></textarea>
                                    <small>(Maximum 200 Characters)</small>
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Podcast Duration"
                                        ...
                                        value="<?php echo e($pod_details[0]->duration_in_min_fr); ?>">
                                        <small>(Maximum 120 Characters)</small>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                               ...
                               <audio controls="controls" controlslist="nodownload"
                                        >
                                        <source src="<?php echo url('/'); ?>/roadtrip/public/audio_podcast/<?php echo e($pod_details[0]->pod_audio_de); ?>"  />
                                    </audio>
                            </div>
                            <div class="form-group">
                                <label>Add Podcast Title</label>
                                <input type="text" class="form-control" placeholder="Add Podcast Title" maxlength="120"
                                    name="de_title" required value="<?php echo e($pod_details[0]->pod_title_de); ?>">
                                    <small>(Maximum 120 Characters)</small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="de_des" rows="2" placeholder="Podcast Description"
                                    maxlength="200" required><?php echo e($pod_details[0]->pod_description_de); ?></textarea>
                                    <small>(Maximum 200 Characters)</small>
                            </div>
                            <div class="form-group">
                                    <label>Podcast Duration</label>
                                    <input type="text" class="form-control" placeholder="Podcast Duration"
                                        ...
                                        value="<?php echo e($pod_details[0]->duration_in_min_de); ?>">
                                        <small>(Maximum 120 Characters)</small>
                                </div>
