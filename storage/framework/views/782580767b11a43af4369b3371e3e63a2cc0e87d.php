 ...
 <!-- Content Wrapper. Contains page content -->
                   ...
                   <?php for($i = 0; $i < count($user_list); $i++): ?>
                     <tr>
                      ...
                      <td class="align-middle">
                        <?php if(!empty($user_list[$i]->profile_pic)): ?>
                            <img src="<?php echo url('/');?>/roadtrip/public/images/<?php echo e($user_list[$i]->profile_pic); ?>">
                            <?php else: ?>
                            <img src="dist/img/user.svg">
                        <?php endif; ?>
                        </td>
                      <td class="align-middle"><?php echo e($user_list[$i]->name); ?></td>
                      <td class="align-middle"><?php echo e($user_list[$i]->email); ?></td>
  ...
  <input type="hidden" name="user_id" value="<?php echo e($user_list[$i]->user_id); ?>">

  <?php if($user_list[$i]->user_active_status==1): ?>
  <input name="checkbox" value="<?php echo e($user_list[$i]->user_id); ?>"  id="checkbox"  type="checkbox" checked="">
  
  <?php else: ?>
  <input name="checkbox" value="<?php echo e($user_list[$i]->user_id); ?>"  id="checkbox"  type="checkbox">
