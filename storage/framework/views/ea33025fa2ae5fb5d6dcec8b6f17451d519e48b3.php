                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="phto-set border pt-2 pb-2 text-center" style="height: 300px;">
                                            <label for="banner-img"><img
                                                    src="<?php echo url('/'); ?>/image_podcast/<?php echo e($pod_details[0]->pod_img); ?>"
                            ...
                            <form method="post" action="<?php echo e(route('do_edit_podcast')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <audio controls="controls"  controlslist="nodownload" id="output"  
                                        >
                                        <source src="<?php echo url('/'); ?>/audio_podcast/<?php echo e($pod_details[0]->pod_audio_en); ?>"  />
                                    </audio>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <audio controls="controls" controlslist="nodownload" id=""
                                        >
                                        <source src="<?php echo url('/'); ?>/audio_podcast/<?php echo e($pod_details[0]->pod_audio_fr); ?>" />
                                    </audio>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                               ...
                               <audio controls="controls" controlslist="nodownload"
                                        >
                                        <source src="<?php echo url('/'); ?>/audio_podcast/<?php echo e($pod_details[0]->pod_audio_de); ?>"  />
                                    </audio>
                            </div>
                            <div class="form-group">
                                <label>Add Podcast Title</label>
