            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data" action="<?php echo e(route('do_list_package_edit', $id)); ?>" >
                                   ...
                                   <div class="form-group col-md-6 text-left">
                                        ...
                                        <label for="package-img-new"
                                            style="max-width: 100%; max-height: 100%;display: flex; justify-content: center; align-items: center;"><img
                                                ...
                                                src="<?php echo url('/'); ?>/roadtrip/public/package_images/<?php echo e($package->package_image); ?>">
                                        </label> 
                                        <div class="set-label">
                                   ...
                                   <div class="form-group col-md-6 text-left">
                                        ...
                                        <label for="package-active-img-new"
                                            style="max-width: 100%; max-height: 100%;display: flex; justify-content: center; align-items: center;"><img
                                                ...
                                                src="<?php echo url('/'); ?>/roadtrip/public/package_images/<?php echo e($package->active_image); ?>">
                                        </label> 
                                        <div class="set-label">
                                   ...
                                   <!--  <div class="form-group col-md-6 text-center">
                                        <label for="package-img">Package Image <span class="text-danger">*</span></label>
                                         <div class="phto-set border pt-2 pb-2 text-center" style="height: 180px;">
                                            ...
                                            <label for="package-img" style="max-width: 100%; max-height: 100%; display: flex; justify-content: center; align-items: center;"><img id="output" style="max-height: 100%; max-width: 100%;"  src="<?php echo url('/'); ?>/roadtrip/public/package_images/<?php echo e($package->package_image); ?>"></label>
                                            <div class="set-label">
                                   ...
                                   <!--  <div class="form-group col-md-6 text-center">
                                    <label for="active-img">Package Active Image <span class="text-danger">*</span></label>
                                      <div class="phto-set border pt-2 pb-2 text-center" style="height: 180px;">
                                          ...
                                          <label for="active-img" style="max-width: 100%; max-height: 100%;  display: flex; justify-content: center; align-items: center;"><img id="output1" style="max-height: 100%; max-width: 100%;"  src="<?php echo url('/'); ?>/roadtrip/public/package_images/<?php echo e($package->active_image); ?>"></label>
                                          <div class="set-label">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Package Name"
                                            required="" maxlength="25" value="<?php echo e($package->package_name); ?>" name="package_name">
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" class="form-control" placeholder="Enter Price in USD"
                                            required=""  maxlength="8" value="<?php echo e($package->package_price); ?>"  name="package_price">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Sequence <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" placeholder="Enter Sequence"
                                            required=""  maxlength="8" value="<?php echo e($package->sequence); ?>"  name="sequence">
                                    </div>
                                     ...
                                     <div class="clearfix"></div>
                                        ...
                                        <input type="text" id="package_name_fr" class="form-control" placeholder="Enter Package Name"
                                            required="" maxlength="25" value="<?php echo e(@$french_package->package_name); ?>" name="package_name_fr">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="8" value="<?php echo e(@$french_package->package_price); ?>" name="package_price_fr">
                                    </div>
                                    ...
                                    <div class="clearfix"></div>
                                        ...
                                        <input type="text" id="package_name_de" class="form-control" placeholder="Enter Package Name"
                                            required="" maxlength="25" value="<?php echo e(@$german_package->package_name); ?>" name="package_name_de">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="8" value="<?php echo e(@$german_package->package_price); ?>" name="package_price_de">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control" name="allowed_routes" data-placeholder="Select Daily Routes" required>
                                            <?php for($i = 1; $i <= 10; $i++): ?>
                                                <option value="<?php echo e($i); ?>" <?php echo e(old('allowed_routes', $package->allowed_routes) == $i ? 'selected' : ''); ?>>
                                                    <?php echo e($i); ?>

                                                </option>
                                            <?php endfor; ?>
                                            <option value="all" <?php echo e(old('allowed_routes', $package->allowed_routes) == 'all' ? 'selected' : ''); ?>>
                                                All
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control" name="allowed_podcasts" data-placeholder="Select Podcasts" required>
                                            <?php for($i = 1; $i <= 10; $i++): ?>
                                                <option value="<?php echo e($i); ?>" <?php echo e(old('allowed_podcasts', $package->allowed_podcasts) == $i ? 'selected' : ''); ?>>
                                                    <?php echo e($i); ?>

                                                </option>
                                            <?php endfor; ?>
                                            <option value="all" <?php echo e(old('allowed_podcasts', $package->allowed_podcasts) == 'all' ? 'selected' : ''); ?>>
                                                All
                                            </option>
                                        </select>
                                    </div>
