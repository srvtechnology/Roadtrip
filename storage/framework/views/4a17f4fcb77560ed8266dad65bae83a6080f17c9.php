                                ...
                                <tbody>
                                    <?php $__currentLoopData = $user_package; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="align-middle"><a href="<?php echo url('/'); ?>/roadtrip/public/package_images/<?php echo e($package->package_image); ?>" target="_blank"> <img class="shadow" style="width:60px; height:60px; object-fit: cover; object-position: center;"  src="<?php echo url('/'); ?>/roadtrip/public/package_images/<?php echo e($package->package_image); ?>"></a></td>
                                            <td class="align-middle"><a href="<?php echo url('/'); ?>/roadtrip/public/package_images/<?php echo e($package->active_image); ?>" target="_blank"><img class="shadow"  style="width:60px; height:60px; object-fit: cover; object-position: center;"  src="<?php echo url('/'); ?>/roadtrip/public/package_images/<?php echo e($package->active_image); ?>"></a></td>
                                            ...
                                            <td class="align-middle" style="display:none">
                                              ...
                                              <td class="align-middle">
                                                <?php echo e($package->allowed_routes); ?> 
                                              </td>

                                               <td class="align-middle">
                                                <?php echo e($package->allowed_podcasts); ?> 
                                              </td>
