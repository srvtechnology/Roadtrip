          ...
          <div class="col-md-12 col-sm-12 col-xs-12 col-lg-5"> 
            <div class="card">
              ...
              <div class="banner-img-area border p-2 shadow">
                                        <a href="<?php echo url('/'); ?>/image_podcast/<?php echo e($podcast_details[0]->pod_img); ?>"
                                            data-toggle="lightbox" data-title="Podcast Image"> <img class="d-block w-100"
                                                src="<?php echo url('/'); ?>/image_podcast/<?php echo e($podcast_details[0]->pod_img); ?>"
                                                style=" height:400px; object-position: center; object-fit: cover;" ></a>
                                    </div>
               
            		<!-- <img class="d-block w-100"  src="<?php echo url('/'); ?>/image_podcast/<?php echo e($podcast_details[0]->pod_img); ?>" style="cursor: pointer;"> -->
            	</div>
            </div>
          </div>
...
<!--   <li class="nav-item" role="presentation">
  ...
  <div class="tab-pane fade show active" id="pills-english" role="tabpanel" aria-labelledby="pills-home-tab">
    ...
    <div class="podcast-dur mt-4">
  	...
  	<div class="podcast-news mt-4">
  		<audio controls="controls" class="w-100" controlslist="nodownload">
                      <source src="<?php echo url('/'); ?>/audio_podcast/<?php echo e($podcast_details[0]->pod_audio_en); ?>" type="audio/mp4" />
                       </audio>
  	</div>
  </div>
    ...
    <div class="podcast-dur mt-4">
  	...
  	<div class="podcast-news mt-4">
  		<audio controls="controls" class="w-100" controlslist="nodownload">
                      <source src="<?php echo url('/'); ?>/audio_podcast/<?php echo e($podcast_details[0]->pod_audio_fr); ?>" type="audio/mp4" />
                       </audio>
  	</div>
  </div>
   ...
   <div class="tab-pane fade" id="pills-german" role="tabpanel" aria-labelledby="pills-home-tab">
    ...
    <div class="podcast-dur mt-4">
  	...
  	<div class="podcast-news mt-4">
  		<audio controls="controls" class="w-100" controlslist="nodownload">
                      <source src="<?php echo url('/'); ?>/audio_podcast/<?php echo e($podcast_details[0]->pod_audio_de); ?>" type="audio/mp4" />
                       </audio>
  	</div>
  </div>
</div>
