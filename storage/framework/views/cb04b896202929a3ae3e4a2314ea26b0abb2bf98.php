		...
		<div class="container-login100" style="background-image: url('<?php echo url('/');  ?>/email_css/images/background.jpg');">
			...
			<div class="wrap-login100 p-t-50 p-b-30" id="form">
				<form class="login100-form validate-form" id="update_form" method="POST">
					...
					<input type="hidden" name="lc" value="<?php echo e(@$lc); ?>">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Password is required">
						<input class="input100" type="password" name="password" <?php if($lc=="en"): ?> placeholder="New Password" <?php elseif($lc=="fr"): ?> placeholder="Nouveau mot de passe"  <?php elseif($lc=="de"): ?> placeholder="Neues Passwort"  <?php else: ?>  placeholder="New Password" <?php endif; ?> minlength="8" maxlength="50">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Password is required">
						<input class="input100" type="password" name="confirm_password"  <?php if($lc=="en"): ?> placeholder="Confirm Password" <?php elseif($lc=="fr"): ?> placeholder="Confirmer mot de passe"  <?php elseif($lc=="de"): ?> placeholder="Passwort bestätigen"  <?php else: ?>  placeholder="Confirm Password" <?php endif; ?> minlength="8" maxlength="50">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock"></i>
						</span>
					...
					<input type="hidden" name="user_email" value="<?php echo e($email); ?>">
    ...
    $("#update").on("click", function() {
     ...
     var formData = $("#update_form").serializeArray();
        ...
        $.ajax({
            ...
            type: "POST",
            url: "<?php echo e(route('update_password')); ?>",
            data: formData,
            beforeSend: function() {
               $("#loader-wrapper").show();
            },
