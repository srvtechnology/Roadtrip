                                ...
                                <tbody>
                                  <tr>
                                    <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                      ...
                                      padding: 0'><span style="text-transform:uppercase">Reset Password</span></h2>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                                ...
                                <tbody>
                                  <tr>
                                    <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                      ...
                                      line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
                                      padding-bottom: 9px; padding-left: 18px;' valign="top">Not to worry, we got you! Let’s <br>get you a new password.
                                      <br></br>
                                    </td>
                                  </tr>
                                </tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="mcnButtonContent" style="mso-line-height-rule:
                                              ...
                                              #FFFFFF; text-transform:uppercase;" target="_blank" title="Reset Password ">Reset password</a>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                ...
                                <tr>
                                  <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                    ...
                                    <p style='margin: 10px 0; padding: 0; mso-line-height-rule: exactly;
                                      ...
                                      Hi,
                                      <br><br>
                                      We’ve received a request to reset your password. If you did not make this request please ignore this message. If you did request to reset your password please follow the above button to reset your password.
                                      <br><br>
                                      Thanks,
                                      <br>
                                      The Road Trip Team
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                        ...
                                        <div style="text-align: center;">@ Copyright 2022
                                          by
                                          <a href="#" style="mso-line-height-rule: exactly;
                                            -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #121212;
                                          font-weight: normal; text-decoration: none; color:#121212;" target="_blank" title="Noun Project - Icons for Everything">Road Trip USA</a>
                                        </div>
                                      </td>
                                    </tr>
                                  <tbody></tbody>
