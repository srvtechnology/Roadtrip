                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="mcnButtonContent" style="mso-line-height-rule:
                                              ...
                                              <a class="mcnButton " href="https://admin.roadtripusasouthwest.com/forgot_password/<?php echo md5($userName);?>/<?php echo base64_encode($userName);?>/<?php echo hash('sha256', $userName);?>/<?php echo $language_code ?>" style="mso-line-height-rule: exactly;
