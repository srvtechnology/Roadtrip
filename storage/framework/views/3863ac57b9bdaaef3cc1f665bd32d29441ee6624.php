                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="phto-set border pt-2 pb-2 text-center" style="height: 150px;">
                                        <label for="banner-img"><img src="<?php echo url('/'); ?>/image_route/<?php echo e($route_details[0]->route_top_banner_img); ?>" id="thumbnil"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="phto-set border pt-2 pb-2 text-center">
                                        <label for="map-img"><img src="<?php echo url('/'); ?>/image_route/<?php echo e($route_details[0]->route_map_banner_img); ?>" id="thumbnil2"
                                                style="max-width:100%; max-height:100px;"></label>
                                        <div class="set-label">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="en-audio" accept="audio/x-m4a" type="file" name="en_fileAudio" 
                                        style="display: none;" value="<?php echo url('/'); ?>/audio_route/<?php echo e($route_details[0]->route_audio_en); ?>" onchange="loadFile(event)"/>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="fr-audio" class="btn btn-info">Upload <i
                                            class="fa fa-upload"></i></label>
                                    <input id="fr-audio" accept=".m4a" type="file" name="fr_fileAudio" value="<?php echo url('/'); ?>/audio_route/<?php echo e($route_details[0]->route_audio_fr); ?>"
                                        style="display: none;" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="de-audio" class="btn btn-info">Upload <i
                                            class="fa fa-upload"></i></label>
                                    <input id="de-audio" accept=".m4a" type="file" name="de_fileAudio" value="<?php echo url('/'); ?>/audio_route/<?php echo e($route_details[0]->route_audio_de); ?>"
                                        style="display: none;" />
                                    <small id="emailHelp" class="form-text text-muted">(Accept Only M4A Audio)</small>
