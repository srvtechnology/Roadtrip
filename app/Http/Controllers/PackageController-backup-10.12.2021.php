...
class PackageController extends Controller
{
    ...
    public function do_list_package_add(Request $request)
    {
        ...
        $validateFields = array('package_image' => 'required|image|mimes:png,jpg,jpeg|max:200|dimensions:max_width=1152,max_height=384',
            'package_active_image' => 'required|image|mimes:png,jpg,jpeg|max:200|dimensions:max_width=1152,max_height=384');
    ...
    public function do_list_package_edit__do(Request $request, $id)
    {
        $data = "Hi";
        echo json_encode($id);
    }
