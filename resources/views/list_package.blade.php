                            ...
                            <table id="list_dailyroute" class="table route_table  table-striped">
                                <thead class="table-dark">
                                    <tr>
                                       ...
                                       {{--  <th>Daily Routes</th>
                                        <th>Podcasts</th> --}}
                                         <th>Allowed Daily Routes</th>
                                        <th>Allowed Podcasts</th>
                                        <th>Sequence</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($user_package as $index => $package)
                                        <tr>
                                            ...
                                            <td class="align-middle"><a href="<?php echo url('/'); ?>/roadtrip/public/package_images/{{ $package->package_image }}" target="_blank"> <img class="shadow" style="width:60px; height:60px; object-fit: cover; object-position: center;"  src="<?php echo url('/'); ?>/roadtrip/public/package_images/{{ $package->package_image }}"></a></td>
                                            <td class="align-middle"><a href="<?php echo url('/'); ?>/roadtrip/public/package_images/{{ $package->active_image }}" target="_blank"><img class="shadow"  style="width:60px; height:60px; object-fit: cover; object-position: center;"  src="<?php echo url('/'); ?>/roadtrip/public/package_images/{{ $package->active_image }}"></a></td>
                                            <td class="align-middle">{{ $package->package_name }}</td>
                                            <td class="align-middle"><i
                                                    class="fa fa-usd"></i>{{ $package->package_price }} USD</td>
                                            <td class="align-middle abc" style="display:none">
                                            ...
                                            <td class="align-middle" style="display:none">
                                              ...
                                              <td class="align-middle">
                                                {{ $package->allowed_routes }} 
                                              </td>

                                               <td class="align-middle">
                                                {{ $package->allowed_podcasts }} 
                                              </td>
      ...
      <form method="POST" action="all_type_delete">
       ...
       <div class="message-txt text-center">
         ...
         <div class="yes-nobtn mt-4">
            <a href="{{ route('deletePackage',$package->package_id) }}" class="btn btn-sm"  title="Delete" style="background-color: #C68F60; color: #ffffff">Yes</i></a>
