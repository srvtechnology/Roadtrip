                                ...
                                <tbody>
                                    @foreach ($user_package as $index => $package)
                                        <tr>
                                            ...
                                            <td class="align-middle"><a href="<?php echo url('/'); ?>/package_images/{{ $package->package_image }}" target="_blank"> <img class="shadow" style="width:60px; height:60px; object-fit: cover; object-position: center;"  src="<?php echo url('/'); ?>/package_images/{{ $package->package_image }}"></a></td>
                                            <td class="align-middle"><a href="<?php echo url('/'); ?>/package_images/{{ $package->active_image }}" target="_blank"><img class="shadow"  style="width:60px; height:60px; object-fit: cover; object-position: center;"  src="<?php echo url('/'); ?>/package_images/{{ $package->active_image }}"></a></td>
