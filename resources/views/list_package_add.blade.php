                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                     ...
                                     {{-- french start --}}
                                        ...
                                        <input type="text" id="package_name_fr" class="form-control" placeholder="Enter Package Name"
                                            required="" maxlength="25" value="{{ old('package_name_fr') }}" name="package_name_fr">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="8" value="{{ old('package_price') }}" name="package_price_fr">
                                    </div>
                                    ...
                                    <div class="clearfix"></div>
                                     ...
                                     {{-- german --}}
                                        ...
                                        <input type="text" id="package_name_de" class="form-control" placeholder="Enter Package Name"
                                            required="" maxlength="25" value="{{ old('package_name_de') }}" name="package_name_de">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="8" value="{{ old('package_price') }}" name="package_price_de">
                                    </div>
