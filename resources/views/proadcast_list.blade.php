                ...
                <table id="pod_list_brodcast" class="table route_table  table-striped">
                  ...
                  <tbody class="popup-gallery">
                    ...
                    <tr>
                      ...
                      <td class="align-middle"><a href="<?php echo url('/'); ?>/roadtrip/public/image_podcast/{{ $podcast_list[$i]->pod_img}}" class="test-popup-link"><img  src="<?php echo url('/'); ?>/roadtrip/public/image_podcast/{{ $podcast_list[$i]->pod_img}}"></a></td>
                      
                      <td class="align-middle">{{ $podcast_list[$i]->pod_title_en}}</td>
                       <td class="align-middle">
                              {{ $podcast_list[$i]->sequence }}
                          </td>
