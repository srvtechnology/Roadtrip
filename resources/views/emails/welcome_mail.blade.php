...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #f1f1f1; height: 100%; margin: 0; padding: 0; width: 100%">
  <center>
 ...
 100%; background-color: #f1f1f1; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
      <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #f1f1f1;
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-image: url(http://demoyourprojects.website/projects/roadtrip/dist/img/background_welcome.jpg); width: 100%; background-repeat: no-repeat; background-size: cover;
 border-top: 0; border-bottom: 50px; padding-top:60px; padding-bottom: 50" valign="top">
 ...
 sans-serif; font-size: 30px; font-style: normal; font-weight: bold; line-height:
 125%; letter-spacing: 1px; text-align: center; display: block; margin: 0;
 padding: 0'><span style="text-transform:uppercase"><img width="100" src="http://demoyourprojects.website/projects/roadtrip/dist/img/icon.png"></span></h2>
                                

                                <h2 class="null" style='color: #ffffff; font-family: "Asap", Helvetica,
 sans-serif; font-size: 30px; font-style: normal; font-weight: bold; line-height:
 125%; letter-spacing: 1px; text-align: center; display: block; margin: 0;
 padding: 0'><span style="text-transform:uppercase">Welcome to Road Trip 2.0</span></h2>
 ...
 -webkit-text-size-adjust: 100%">
                  <div style="padding-top: 0px; padding-bottom: 20px;">
                                <!--    <a href="#"> <img src="http://demoyourprojects.website/projects/roadtrip/dist/img/photos.png" style="max-width:100px"></a>  -->                             
                            </div>
 ...
 0; text-align: left; width: 100%; font-size: 16px; font-weight: bold; '>
                              ...
                              Hello,
                              @endif</h3>
                              <h4 style='color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif;
 font-size: 18px; font-style: normal; font-weight: normal; line-height: 125%;
 letter-spacing: normal; text-align: center; display: block; margin: 0; padding:
 0; text-align: left; width: 100%; font-size: 16px;  margin-top: 20px; '>
 ...
 <br>
 Welcome to Road Trip. We are so excited that you have chosen to be a part of our trip!
 <br> <br>
Thanks, 
 <br>
The Road Trip Team
