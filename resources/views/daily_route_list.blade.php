                    ...
                    <table id="list_daily_route_all" class="table route_table  table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="align-middle"><img  src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{$route_list[$i]->route_top_banner_img}}"></td>
                          <td class="align-middle"><img  src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{$route_list[$i]->route_map_banner_img}}"></td>
