...
<button style="display: none;" type="button" id="alert_true" class="btn btn-default toastsDefaultAutohideinfo">
 ...
 is 500 px X 500 px)
                  ...
                  <label for="banner-img"><i class="fa fa-camera"></i></label>
                    ...
                    <input type="file" id="banner-img" accept="image/*"  name="banner_img" onchange="showMyImage(this)" style="display: none;">
                  </div>
         ...
         <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                  ...
                  <div class="form-group">
                    <label>SL NO</label>
                    <input type="number" class="form-control" placeholder="SL NO" maxlength="120" name="en_sl_no" required>
                  </div>
                  <div class="form-group">
                    <label>Package Name</label>
                    <textarea class="form-control" name="PackageName" rows="2" placeholder="Package Name" maxlength="200" required></textarea>
                  </div>

                  <div class="form-group">
                    <label>Price</label>
                    <input type="text" class="form-control" placeholder="Price" maxlength="120" name="en_price" required>
                  </div>
                  <div class="form-group">
                    <label>Daily Route</label>
                    <input type="text" class="form-control" placeholder="Daily Route" maxlength="120" name="en_price" required>
                  </div>
                  <div class="form-group">
                    <label>Podcast</label>
                    <input type="text" class="form-control" placeholder="Podacast" maxlength="120" name="en_price" required>
                  </div>
            ...
            <div class="card">
              ...
              <!-- <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Add Podcast Desription</label>
                    <textarea class="form-control" name="de_des" rows="2" placeholder="Podcast Desription" maxlength="200" required></textarea>
                  </div>
                  <div class="form-group">
    ...
    $('#submit_botton').click(function() {
        ...
        // if (audio_hidden1 === '' || audio_hidden2 === '' || audio_hidden3 === '' ) {
          if (audio_hidden1 === ''  ) {
            ...
            $('#msg_show').val('Test You must upload audio file');
            $("#alert_false").click();
            return false;
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (flag == 'true') {
                    ...
                    $('#msg_show').val('Image should be in the diamention of 500px X 500PX');
                    $("#alert_false").click();
                        $("#loader").hide();
                        $('#done').hide();
                }
