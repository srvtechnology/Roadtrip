                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="phto-set border pt-2 pb-2 text-center" style="height: 150px;">
                                        <label for="banner-img"><img src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $route_details[0]->route_top_banner_img }}" id="thumbnil"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="phto-set border pt-2 pb-2 text-center">
                                        <label for="map-img"><img src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $route_details[0]->route_map_banner_img }}" id="thumbnil2"
                                                style="max-width:100%; max-height:100px;"></label>
                                        <div class="set-label">
                        ...
                        <div class="card languages" id="english" class="size_chart">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" class="form-control" placeholder="Enter Sequence"
                                    required=""  maxlength="8" value="{{@$route_details[0]->sequence}}"  name="sequence">
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="en-audio" accept="audio/x-m4a" type="file" name="en_fileAudio" 
                                        style="display: none;" value="<?php echo url('/'); ?>/roadtrip/public/audio_route/{{ $route_details[0]->route_audio_en }}" onchange="loadFile(event)"/>
                                    ...
                                    <!-- <audio controls="controls" controlslist="nodownload" id="" >
                                        <source src="<?php echo url('/'); ?>/roadtrip/public/audio_route/{{ $route_details[0]->route_audio_en }}"  />
                                    </audio> -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="fr-audio" class="btn btn-info">Upload <i
                                            class="fa fa-upload"></i></label>
                                    <input id="fr-audio" accept=".m4a" type="file" name="fr_fileAudio" value="<?php echo url('/'); ?>/roadtrip/public/audio_route/{{ $route_details[0]->route_audio_fr }}"
                                        style="display: none;" />
                                    ...
                                    <div class="d-flex justify-content-center"><label class="image-previewer"><img
                                      ...
                                      <audio controls="controls" controlslist="nodownload" id="" >
                                        <source src="<?php echo url('/'); ?>/roadtrip/public/audio_route/{{ $route_details[0]->route_audio_fr }}"  />
                                    </audio>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"  name="fr_des" rows="2"
                                        ...
                                        maxlength="2000">{{ $route_details[0]->route_description_fr }}</textarea>
                                         <small>(Maximum 2000 Characters)</small> 
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="de-audio" class="btn btn-info">Upload <i
                                            class="fa fa-upload"></i></label>
                                    <input id="de-audio" accept=".m4a" type="file" name="de_fileAudio" value="<?php echo url('/'); ?>/roadtrip/public/audio_route/{{ $route_details[0]->route_audio_de }}"
                                        style="display: none;" />
                                    <small id="emailHelp" class="form-text text-muted">(Accept Only M4A Audio)</small>
                                    ...
                                    <div class="d-flex justify-content-center"><label class="image-previewer"><img
                                     ...
                                     <audio controls="controls" controlslist="nodownload" id="" >
                                        <source src="<?php echo url('/'); ?>/roadtrip/public/audio_route/{{ $route_details[0]->route_audio_de }}"  />
                                    </audio>
                                </div>
                                <div class="form-group">
                                    <label>Edit Daily Route Title</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="de_des" name="de_des" rows="2"
                                        placeholder="Daily Route Description (Maximum 2000 Characters)"
                                        maxlength="2000">{{ $route_details[0]->route_description_de }}</textarea>
                                         <small>(Maximum 2000 Characters)</small> 
                                </div>
