                                ...
                                <div class="flex-area">
                                        ...
                                        <div class="phto-set border p-2 text-center">
                                            <label for="place_1"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_details[0]->poi_img_1 }}" id="thumbnil"></label>
                                        ...
                                        <div class="phto-set border p-2 text-center">
                                            ...
                                            <label for="place_2"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_details[0]->poi_img_2 }}" id="thumbnil2"></label>
                                            @else
                                            <label for="place_2"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        @if($poi_details[0]->poi_img_3!="")
                                            <label for="place_3"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_details[0]->poi_img_3 }}" id="thumbnil3"></label>
                                                    @else
                                            <label for="place_3"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <label for="place_4"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_details[0]->poi_img_4 }}" id="thumbnil4"></label>
                                                    @else
                                            <label for="place_4"><img style="max-height: 120px; max-width: 100%;"
                                    ...
                                    <!-- Additional images -->
                                        ...
                                        @if($poi_details[0]->poi_img_5!="")  
                                            <label for="place_5"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_details[0]->poi_img_5 }}" id="thumbnil5"></label>
                                                    @else
                                            <label for="place_5"><img style="max-height: 120px; max-width: 100%;"
                                   ...
                                   <div class="flex-area">
                                        ...
                                        <label for="place_6"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_details[0]->poi_img_6 }}" id="thumbnil6"></label>
                                                    @else
                                            <label for="place_6"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <label for="place_7"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_details[0]->poi_img_7 }}" id="thumbnil7"></label>
                                                    @else
                                            <label for="place_7"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <label for="place_8"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_details[0]->poi_img_8 }}" id="thumbnil8"></label>
                                                    @else
                                            <label for="place_8"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <label for="place_9"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_details[0]->poi_img_9 }}" id="thumbnil9"></label>
                                                    @else
                                            <label for="place_9"><img style="max-height: 120px; max-width: 100%;"
                                        ...
                                        <label for="place_10"><img style="max-height: 120px; max-width: 100%;"
                                                    src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_details[0]->poi_img_10 }}" id="thumbnil10"></label>
                                                    @else
                                            <label for="place_10"><img style="max-height: 120px; max-width: 100%;"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" class="form-control" placeholder="Enter Sequence"
                                    required=""  maxlength="8" value="{{@$poi_details[0]->sequence}}"  name="sequence">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                    ...
                                    <div class="d-flex justify-content-left"><label class="image-previewer"><img
                                        ...
                                        <source src="<?php echo url('/'); ?>/roadtrip/public/audio_route/{{ $poi_details[0]->poi_audio_en }}"  />
                                    </audio>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" maxlength="100" placeholder="Place Name"
                                            name="fr_place_name" value="{{ @$poi_details[0]->poi_name_fr }}" required>
                                            <small>(Maximum 100 Characters)</small> 
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-left"><label class="image-previewer"><img
                                         ...
                                         @if($poi_details[0]->poi_audio_fr)
                                         <audio controls="controls" controlslist="nodownload" id="output">
                                        <source src="<?php echo url('/'); ?>/roadtrip/public/audio_route/{{ $poi_details[0]->poi_audio_fr }}"  />
                                            @else
                                            <P>No Audio</P>
                                        @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="Description" maxlength="2000" name="fr_place_des"
                                            rows="6" required> {{ @$poi_details[0]->poi_description_fr }}</textarea>
                                            <small>(Maximum 2000 Characters)</small> 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" maxlength="100" placeholder="Place Name"
                                            name="de_place_name" required value="{{ @$poi_details[0]->poi_name_de }}">
                                            <small>(Maximum 100 Characters)</small> 
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-left"><label class="image-previewer"><img
                                         ...
                                         @if($poi_details[0]->poi_audio_de)

                                        <audio controls="controls" controlslist="nodownload" id="output">
                                        <source src="<?php echo url('/'); ?>/roadtrip/public/audio_route/{{ $poi_details[0]->poi_audio_de }}"  />
                                    </audio>
                                      @else
                                            <P>No Audio</P>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="Description" maxlength="2000" name="de_place_des"
                                            rows="6" required> {{@$poi_details[0]->poi_description_de}}</textarea>
                                            <small>(Maximum 2000 Characters)</small> 
                                    </div>
                                </div>
                            </div>
