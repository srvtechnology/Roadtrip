                                   ...
                                   <div class="form-group col-md-6 text-left">
                                        ...
                                        <label for="package-img-new"
                                            style="max-width: 100%; max-height: 100%;display: flex; justify-content: center; align-items: center;"><img
                                                ...
                                                src="<?php echo url('/'); ?>/package_images/{{ $package->package_image }}">
                                        </label> 
                                        <div class="set-label">
                                   ...
                                   <div class="form-group col-md-6 text-left">
                                        ...
                                        <label for="package-active-img-new"
                                            style="max-width: 100%; max-height: 100%;display: flex; justify-content: center; align-items: center;"><img
                                                ...
                                                src="<?php echo url('/'); ?>/package_images/{{ $package->active_image }}">
                                        </label> 
                                        <div class="set-label">
        ...
        reader.readAsDataURL(event.target.files[0]);
                                   ...
                                   <!--  <div class="form-group col-md-6 text-center">
                                        <label for="package-img">Package Image <span class="text-danger">*</span></label>
                                         <div class="phto-set border pt-2 pb-2 text-center" style="height: 180px;">
                                            ...
                                            <label for="package-img" style="max-width: 100%; max-height: 100%; display: flex; justify-content: center; align-items: center;"><img id="output" style="max-height: 100%; max-width: 100%;"  src="<?php echo url('/'); ?>/package_images/{{ $package->package_image }}"></label>
                                            <div class="set-label">
                                   ...
                                   <!--  <div class="form-group col-md-6 text-center">
                                    <label for="active-img">Package Active Image <span class="text-danger">*</span></label>
                                      <div class="phto-set border pt-2 pb-2 text-center" style="height: 180px;">
                                          ...
                                          <label for="active-img" style="max-width: 100%; max-height: 100%;  display: flex; justify-content: center; align-items: center;"><img id="output1" style="max-height: 100%; max-width: 100%;"  src="<?php echo url('/'); ?>/package_images/{{ $package->active_image }}"></label>
                                          <div class="set-label">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control select2" multiple="" name="routes[]" required="">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control select2" multiple="" name="podcasts[]" required="">
