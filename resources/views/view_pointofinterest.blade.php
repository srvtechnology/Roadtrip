                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="banner-img-area border p-2 shadow">
                                        <a href="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $route_details[0]->route_top_banner_img }}"
                                            data-toggle="lightbox" data-title="Top Banner Image"> <img class="d-block w-100"
                                                src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $route_details[0]->route_top_banner_img }}"
                                                style="height: 200px; object-position: center; object-fit: cover;"></a>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="banner-img-area border p-2 shadow">
                                        <a href="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $route_details[0]->route_map_banner_img }}"
                                            data-toggle="lightbox" data-title="Map Banner Image"> <img class="d-block w-100"
                                                src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $route_details[0]->route_map_banner_img }}"
                                                style="height: 200px; object-position: center; object-fit: cover;"></a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <tbody>
                                                  @for($i = 0; $i < count($poi_list); $i++)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle"><img src="<?php echo url('/'); ?>/roadtrip/public/image_route/{{ $poi_list[$i]->poi_img_1 }}"></td>
                                                        ...
                                                        <td class="align-middle text-center"><audio controls="controls" onplay="pauseOthers(this);"
                                                                controlslist="nodownload">
                                                                <source src="<?php echo url('/'); ?>/roadtrip/public/audio_route/{{ $poi_list[$i]->poi_audio_en }}" />
                                                            </audio></td>
