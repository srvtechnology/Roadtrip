...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('/forgot_password/{serect_key}/{secutity_token}/{email}/{lc}', array('as' => 'forgot_password_mail', 'uses' => 'userController@forgot_password_mail'));
    ...
    Route::get('/terms_conditions/de', array('as' => 'terms_condition_de', 'uses' => 'userController@terms_condition_de'));
    Route::get('/privacy_policy/de', array('as' => 'privacy_policy_de', 'uses' => 'userController@privacy_policy_de'));
    Route::get('/about/de', array('as' => 'about_de', 'uses' => 'userController@about_de'));

    Route::get('/terms_conditions/fr', array('as' => 'terms_condition_fr', 'uses' => 'userController@terms_condition_fr'));
    Route::get('/privacy_policy/fr', array('as' => 'privacy_policy_fr', 'uses' => 'userController@privacy_policy_fr'));
    Route::get('/about/fr', array('as' => 'about_fr', 'uses' => 'userController@about_fr'));
