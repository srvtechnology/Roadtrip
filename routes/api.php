...
Route::middleware('api')->namespace('api')->group(function () {
    ...
    Route::post('/user-used-data-count-insert', "PaymentController@user_used_data_count");
     Route::post('/user-used-data-count-get', "PaymentController@user_used_data_count_get");
